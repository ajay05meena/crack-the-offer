...
This repo defines custom Claude Code skills under `.claude/skills/` that act as interviewers reviewing your work, plus one that guards how work gets committed:
